    ...
    <div className=' glass px-6 max-w-[1000px] mx-auto flex flex-col md:flex-row place-items-center justify-between' id='contact'>
        <div className=' flex flex-col gap-4 py-2'>
            ...
            <div className=" flex gap-5">
                <a href='https://www.linkedin.com/in/n0or-chowdhury/'><AiFillLinkedin className=' text-blue-400' size={60}/></a>
                <a href='https://m.me/n0.or.chowdhury'><FaFacebookMessenger size={60} className=' text-blue-600' /></a>
            </div>
        </div>
